...
<html lang="pt-br">
  ...
  <body>
        ...
        <header class=" position-relative fixed-top navbar-expand-sm">
                ...
                <nav class="navbar cor-vermelho navbar-dark navbar-expand-lg">
                    ...
                    <div class="container">
                        ...
                        <a class="navbar-brand h1 mb-0" href="#"><i class="fa fa-home"></i> Inicio</a>
      ...
      <div class="container">
          ...
          <div class="row">
              ...
              <div class="col-12 text-center my-5">
                  ...
                  <h1 class="display-3"><i class="fa fa-cogs text-dark" aria-hidden="true"><a name="about">Acerca da plataforma</a></i></h1>
            ...
            <div class="col-sm-6 col-md-4 mb-3">
                ...
                <nav id="navbarVertical" class="navbar navbar-light bg-light">
                    ...
                    <nav class="nav nav-pills nav-warning flex-column">
                        ...
                        <a class="nav-link cor-vermelho " href="#item1">Quem somos</a>
          ...
          <div class="col-12 text-center my-5">
            ...
            <h1 class="display-3"><i class="fa fa-book text-dark" aria-hidden="true"><a name="books">Livros populares</a></i></h1>
            <p><a href="catalogos.html">Clique aqui para ver o catalogo completo</a></p>
      ...
      <footer class="container-fluid page-footer bg-dark">
 
          
          <div class="row mt-2 p-3 footer-border bgfooter dark-grey-text" id="rodape">
              
              <div class="col-sm-4">
              
                  <h3 class="text-light">Categorias</h3>
                  
                 <ul id="util">
                    <li><a href="#">Livros fisicos</a></li>
                    <li><a href="#">Livros digitais</a></li>
              ...
              <div class="col-sm-4">
                  ...
                  <h3 class="text-light">Galeria</h3>

                  <div class="col-7" id="cima">
                      <img src="imgs/slide-02.jpg" class="img-fluid d-block">
                  </div>

                  <div class="col-8" id="baixo-left">
                       <img src="imgs/slide-01.jpg" class="img-fluid d-block">
                  </div>
              ...
              <div class="col-sm-4">
                    ...
                    <h3 class="text-light">Endereço</h3>
                <!--  
